...
import (
	...
	// bwcdisk "bosh-proxmox-cpi/disk"
	// bwcstem "bosh-proxmox-cpi/stemcell"
	// bwcutil "bosh-proxmox-cpi/util"
	// bwcvm "bosh-proxmox-cpi/vm"
)
...
func NewFactory(
	proxmoxClient wrdnclient.Client,
	...
	// 	uuidGen, proxmoxClient, metadataService, agentEnvServiceFactory, ports,
	// 	hostBindMounts, guestBindMounts, systemResolvConfProvider, opts.Agent, logger)

	// vmFinder := bwcvm.NewWardenFinder(
	// 	proxmoxClient, agentEnvServiceFactory, ports, hostBindMounts, guestBindMounts, logger)
